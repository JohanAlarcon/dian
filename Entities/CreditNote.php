 ...
 * Factura Electrónica - CreditNote (raíz)
 *
 ...
 * @property string $CreditNoteTypeCode    Código del tipo de factura (01, 02, 03, 04, 91, 92, 96).
...
class CreditNote
{
    ...
    /**
     * Constructor de la clase CreditNote.
     *
    ...
    public function toXML()
    {
        ...
        // Crear nodo raíz CreditNote
        $invoiceNode = $dom->createElement('CreditNote');

        // --------------------------------------------------------------------------------------
        // Atributos del elemento <CreditNote>
        // --------------------------------------------------------------------------------------
        $invoiceNode->setAttribute('xmlns', 'urn:oasis:names:specification:ubl:schema:xsd:CreditNote-2');
        ...
        $invoiceNode->setAttribute('xsi:schemaLocation', 'urn:oasis:names:specification:ubl:schema:xsd:CreditNote-2     http://docs.oasis-open.org/ubl/os-UBL-2.1/xsd/maindoc/UBL-CreditNote-2.1.xsd');
        ...
        $invoiceNode->appendChild(XMLGenerator::createNode($dom, 'cbc:CreditNoteTypeCode', $this->CreditNoteTypeCode));
        ...
        // --------------------------------------------------------------------------------------
        $invoiceNode->appendChild($this->InvoicePeriod->toXML($dom));
