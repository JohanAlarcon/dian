...
class InvoiceApplicationResponse
{
    ...
    public function generateXML(array $data, array $data_fac)
    {
        ...
        $partyTaxScheme = new PartyTaxScheme("Unidad Especial Direccion de Impuestos y Aduanas Nacionales", $companyID, "", null, $taxScheme, "");
        ...
        /* $fileName = 'aplicationResponse.xml';
