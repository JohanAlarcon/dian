...
class CreditNoteTransformer
{
    ...
    public function __construct(array $data, array $data_fac, $referenciada)
    {
        ...
        require_once __DIR__ . '/../../Entities/CreditNote.php';
        ...
        require_once __DIR__ . '/../../Entities/CreditNoteLine.php';
    ...
    public function generateXML()
    {
        try {
            ...
            $ublExtensions = $this->createUblExtensions();
            ...
            $InvoicePeriod = new InvoicePeriod($StartDate, $StartTime, $EndDate, $EndTime);
